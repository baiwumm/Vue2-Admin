...
## 项目简介
  ...
  [vue-admin-xmw-pro](http://vue2.xmwpro.com/) 是一个后台管理系统解决方案，采用前后端分离技术开发。它使用了最新的技术栈，提供了丰富的功能组件，希望本项目可以帮助到您。
...
- [🚀 github 仓库地址](https://github.com/Cyan-Xmw/vue-xmw-admin-pro/)

- [🚀 码云仓库地址](https://gitee.com/Cyan-Xmw/vue-xmw-admin-pro/)

- 📄 文档地址：**正在编写中！**

- ❤️ star：**如果可以的话，请顺手给个star，表示对作者的鼓励，万分感谢！**

- 😝 Vue3+Typescript版本： [vue3-xmw-admin-pro](https://gitee.com/Cyan-Xmw/vue3-xmw-admin-pro/)
